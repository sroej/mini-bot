...
const config = {
    ...
    OWNER_NUMBER: '2250575632061',
    BOT_VERSION: '1.0.0',
    BOT_FOOTER: '> © ᴍᴀᴅᴇ ʙʏ ʏᴏᴀɴɴ-ᴏғғɪᴄɪᴀʟ',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbB01rxElagqKvvvbR0a',
    BUTTON_IMAGES: {
        ALIVE: 'https://files.catbox.moe/7sx6cd.jpg',
        MENU: 'https://files.catbox.moe/7sx6cd.jpg',
        OWNER: 'https://files.catbox.moe/7sx6cd.jpg',
        SONG: 'https://files.catbox.moe/7sx6cd.jpg,
        VIDEO: 'https://files.catbox.moe/7sx6cd.jpg'
    }
};
